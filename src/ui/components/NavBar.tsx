...
export default function NavBar() {
  ...
  return (
    <div className="flex items-center justify-between border-b border-navy-700 bg-navy-900/80 px-4 py-2 backdrop-blur">
      ...
      <div className="flex items-center gap-2 text-xs">
        <span className="text-steel-400">Reputation</span>
